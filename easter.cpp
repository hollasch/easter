//**********************************************************************************************************************
// This program prints the date of Easter given the year number. If no argument is supplied, the next occurance of
// Easter is printed.
//
// This algorithm is taken from the following Usenet article in sci.math:
//
//     ================================================================================
...
int main () {
    return 0;
        ...
        // **** Original Source from easter.pl: ****
        //
        // $year  = $ARGV[0];
        // $month = 0;
        // $day   = 0;
